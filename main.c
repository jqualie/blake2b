...
int main(int argc, void* argv)
{
	...
	{
		// a15c962d3f6c50d2561ae9d323b0227dd3e61132886d91267a9170806a6b5d1d3c89588b68e1635beebb485050cf614bdfd969359ef0a97864fd3e7d5d7c2ed6
		int len = 16384;
		uint8_t* uin = malloc(len);
		for (int i = 0; i < len; i++)
		{
			uin[i] = i & 0xFF;
		}
